...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="card mt-4">
            <div class="card-body">
                <form action="{{ route('notice.update', ['id' => $notices->id]) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" value=" {{ $notices->title }}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="departman_id" id="notice_type" class="form-control selectpicker"
                                            data-live-search="true" required>
                                            <option value="">Seçiniz</option>
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->id }}"
                                                    {{ $department->id == $notices->departman_id ? 'selected' : '' }}>
                                                    {{ $department->name }}
                                ...
                                <div class="col-md-3 " id="noticeOption">
                                    <div class="form-group">
                                        ...
                                        <select name="employee_id[]" multiple id="employee_id"
                                            class="form-control selectpicker" data-live-search="true" required>
                                            @foreach ($employees as $employee)
                                                <option
                                                    value="{{ $employee->id }}"{{ $notices->employee->contains($employee->id) ? 'selected' : '' }}>
                                                    {{ $employee->name }}
                    ...
                    <h4 style="padding-top:20px">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea id="description" name="description" class="form-control">{{ $notices->description }}</textarea>
                            </div>
                        </div>
